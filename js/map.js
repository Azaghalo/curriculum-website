...
function initialize() {
	...
	console.log("PQ CHAMOU PORRA?");

	var mapProp = {
		center: new google.maps.LatLng(-30.021707210840862, -51.176003695444805),
		zoom: 17,
		scrollwheel: true,
		styles: [{
			stylers: [{
	...
	addMarker(-30.021707210840862, -51.176003695444805, "", "Here", undefined, true);
}
